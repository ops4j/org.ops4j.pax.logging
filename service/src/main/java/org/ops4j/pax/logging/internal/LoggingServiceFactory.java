...
//    private boolean m_IsUsingGlobal;
    ...
    private ManagedLoggingServiceFactory m_ConfigFactory;
     ...
     */
    public LoggingServiceFactory( ManagedLoggingServiceFactory config, PaxLoggingService paxLogging  )
    {
...
//        m_ConfigFactory.configure( m_MergedProperties );
    ...
    public Object getService( Bundle bundle, ServiceRegistration registration )
    {
        ...
        String loggerName = (String) dictionary.get( ManagedLoggingServiceFactory.LOG4J_LOGGER_NAME );
        if( loggerName != null )
        {
            String configFileName = (String) dictionary.get( ManagedLoggingServiceFactory.LOG4J_CONFIG_FILE );
            try
            {
