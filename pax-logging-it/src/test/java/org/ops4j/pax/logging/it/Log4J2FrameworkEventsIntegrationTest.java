...
public class Log4J2FrameworkEventsIntegrationTest extends AbstractStdoutInterceptingIntegrationTestBase {
    ...
    public void handleFrameworkErrors() throws BundleException, InterruptedException, NoSuchMethodException, InvocationTargetException, IllegalAccessException, ClassNotFoundException {
        Helpers.updateLoggingConfig(context, cm, Helpers.LoggingLibrary.LOG4J2_PROPERTIES, "frameworkEvents");
        ...
        List<String> lines1 = readLines("target/logs-log4j2/framework-events.log");
