...
public class Log4J2WithDefaultConfigurationAndNoLog4j2DebugIntegrationTest extends AbstractControlledIntegrationTestBase {
    ...
    public void logLog() {
        ...
        assertFalse(lines.stream().anyMatch(l -> l.contains("org.ops4j.pax.logging.pax-logging-api [log4j2] DEBUG : StatusLogger debug")));
        ...
        assertFalse(lines.contains("org.ops4j.pax.logging.pax-logging-api [log4j2] INFO : Log4J2 configured using default configuration. Ignored FQCN: org.apache.logging.log4j.spi.AbstractLogger"));
    }
