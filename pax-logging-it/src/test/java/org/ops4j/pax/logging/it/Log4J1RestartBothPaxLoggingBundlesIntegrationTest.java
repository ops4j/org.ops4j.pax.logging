...
public class Log4J1RestartBothPaxLoggingBundlesIntegrationTest extends AbstractStdoutInterceptingIntegrationTestBase {
    ...
    public void restartBothBundles() throws BundleException {
        ...
        // to file, but with
        // "org.ops4j.pax.logging.pax-logging-service [log4j] WARN : No appenders could be found for logger
        // (PaxExam-Probe)."
        ...
        assertTrue("old LogService reference should not work", lines.contains("org.ops4j.pax.logging.pax-logging-service [log4j] WARN : No appenders could be found for logger (PaxExam-Probe)."));
