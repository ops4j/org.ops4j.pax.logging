...
public class Log4J2WithConfigAdminIntegrationTest extends AbstractStdoutInterceptingIntegrationTestBase {
    ...
    public void defaultConfigurationButUsingConfigAdmin() throws IOException, InterruptedException {
        ...
        // after the above update, we should keep the default configuration
