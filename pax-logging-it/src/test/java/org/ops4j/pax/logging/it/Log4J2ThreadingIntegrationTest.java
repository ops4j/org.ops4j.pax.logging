...
public class Log4J2ThreadingIntegrationTest extends AbstractControlledIntegrationTestBase {
    ...
    public void multipleThreads() throws Exception {
        Helpers.updateLoggingConfig(context, cm, Helpers.LoggingLibrary.LOG4J2_PROPERTIES, "threads", d -> {
