...
public class LogbackThreadingIntegrationTest extends AbstractControlledIntegrationTestBase {
    ...
    public void multipleThreads() throws Exception {
        Helpers.updateLoggingConfig(context, cm, Helpers.LoggingLibrary.LOGBACK, "threads", d -> {
