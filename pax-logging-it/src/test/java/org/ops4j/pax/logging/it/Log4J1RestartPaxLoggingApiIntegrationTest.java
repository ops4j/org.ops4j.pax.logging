...
public class Log4J1RestartPaxLoggingApiIntegrationTest extends AbstractStdoutInterceptingIntegrationTestBase {
    ...
    public void restartPaxLoggingApi() throws BundleException {
        ...
        assertTrue("line from DefaultServiceLog when pax-logging-api is stopped (new logger)", lines.contains("PaxExam-Probe [org.ops4j.pax.logging.it.Log4J1RestartPaxLoggingApiIntegrationTest] INFO : When pax-logging-api is stopped (log1)"));
        ...
        assertTrue("line from TTCCLayout when pax-logging-api is started (new logger)", lines.contains("[main] INFO org.ops4j.pax.logging.it.Log4J1RestartPaxLoggingApiIntegrationTest - After restarting pax-logging-api (log1)"));
