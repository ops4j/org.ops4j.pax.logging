...
public class Log4J1MDCIntegrationTest extends AbstractStdoutInterceptingIntegrationTestBase {
    ...
    @Test
    public void mdc() {
        Helpers.updateLoggingConfig(context, cm, Helpers.LoggingLibrary.LOG4J1, "mdc");
        ...
        List<String> lines = readLines("target/logs-log4j1/mdc-file-appender.log");

        assertTrue(lines.stream().anyMatch(l ->
                l.contains("my.logger/org.ops4j.pax.logging.it.Log4J1MDCIntegrationTest")
