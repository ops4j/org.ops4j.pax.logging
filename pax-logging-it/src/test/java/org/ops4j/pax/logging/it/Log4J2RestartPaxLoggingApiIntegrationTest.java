...
public class Log4J2RestartPaxLoggingApiIntegrationTest extends AbstractStdoutInterceptingIntegrationTestBase {
    ...
    public void restartPaxLoggingApi() throws BundleException {
        ...
        // registered by pax-logging-<impl>, so it immediately starts printing through some implementation
        ...
        assertTrue("line from DEFAULT_PATTERN", lines2.contains("[main] INFO  org.ops4j.pax.logging.it.Log4J2RestartPaxLoggingApiIntegrationTest - Before restarting pax-logging-api"));
