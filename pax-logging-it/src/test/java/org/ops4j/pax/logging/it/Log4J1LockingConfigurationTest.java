...
public class Log4J1LockingConfigurationTest extends AbstractStdoutInterceptingIntegrationTestBase {
    ...
    public void turnOnLocks() throws IOException {
        ...
        LoggerFactory.getLogger(Log4J1LockingConfigurationTest.class).info("Hello without locking");

        Helpers.updateLoggingConfig(context, cm, Helpers.LoggingLibrary.LOG4J1, "locks");
        ...
        LoggerFactory.getLogger(Log4J1LockingConfigurationTest.class).info("Hello with locking");

        List<String> lines = readLines();
        assertTrue(lines.contains("[main] INFO org.ops4j.pax.logging.it.Log4J1LockingConfigurationTest - Hello without locking"));
        assertTrue(lines.contains("[main] INFO org.ops4j.pax.logging.it.Log4J1LockingConfigurationTest - Hello with locking"));
    }
