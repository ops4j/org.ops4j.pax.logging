...
public class Log4J2LockingConfigurationTest extends AbstractStdoutInterceptingIntegrationTestBase {
    ...
    public void turnOnLocks() throws IOException {
        ...
        LoggerFactory.getLogger(Log4J2LockingConfigurationTest.class).info("Hello without locking");

        Helpers.updateLoggingConfig(context, cm, Helpers.LoggingLibrary.LOG4J2_XML, "locks");
        ...
        LoggerFactory.getLogger(Log4J2LockingConfigurationTest.class).info("Hello with locking");

        List<String> lines = readLines(13);
        assertTrue(lines.contains("[main] INFO  org.ops4j.pax.logging.it.Log4J2LockingConfigurationTest - Hello without locking"));
        assertTrue(lines.contains("[main] INFO  org.ops4j.pax.logging.it.Log4J2LockingConfigurationTest - Hello with locking"));
    }
    ...
    private static class FieldConsumer implements Consumer<Field> {
        ...
        public void accept(Field f) {
            if (f.getType().getName().equals("org.ops4j.pax.logging.log4j2.internal.PaxLoggingServiceImpl")) {
