...
public class Log4J2MarkersIntegrationTest extends AbstractStdoutInterceptingIntegrationTestBase {
    ...
    public void loggingWithMarkers() {
        Helpers.updateLoggingConfig(context, cm, Helpers.LoggingLibrary.LOG4J2_PROPERTIES, "markers");
        ...
        assertTrue(lines.contains("my.logger/org.ops4j.pax.logging.it.Log4J2MarkersIntegrationTest [INFO] (slf4j-marker-1[ slf4j-marker-2[ pass ] ] | slf4j-marker-1) INFO using SLF4J with marker"));
        assertTrue(lines.contains("my.logger/org.ops4j.pax.logging.it.Log4J2MarkersIntegrationTest [INFO] (log4j2-marker-1[ log4j2-marker-2[ pass ] ] | log4j2-marker-1) INFO using Log4Jv2 with marker"));
        assertTrue(lines.contains("my.logger/org.ops4j.pax.logging.it.Log4J2MarkersIntegrationTest [INFO] (slf4j-marker-1[ slf4j-marker-2[ pass ] ] | slf4j-marker-1) INFO using PaxLogger with SLF4J marker"));
        assertTrue(lines.contains("my.logger/org.ops4j.pax.logging.it.Log4J2MarkersIntegrationTest [INFO] (log4j2-marker-1[ log4j2-marker-2[ pass ] ] | log4j2-marker-1) INFO using PaxLogger with Log4J2 marker"));
