...
public class Log4J1FrameworkEventsIntegrationTest extends AbstractStdoutInterceptingIntegrationTestBase {
    ...
    public void handleFrameworkErrors() throws BundleException, InterruptedException, NoSuchMethodException, InvocationTargetException, IllegalAccessException, ClassNotFoundException {
        Helpers.updateLoggingConfig(context, cm, Helpers.LoggingLibrary.LOG4J1, "frameworkEvents");
        ...
        List<String> lines1 = readLines("target/logs-log4j1/framework-events.log");
        ...
        assertTrue(lines2.contains("[main] INFO org.osgi.framework.BundleEvent - BundleEvent STARTED"));
