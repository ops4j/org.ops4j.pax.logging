...
public class MDCTest extends TestCase {
	...
	public void testNonInheritedMDC() throws Exception {
		System.setProperty(PaxContext.INHERIT_THREAD_CONTEXT_MAP_KEY, "false");
	...
	public void testInheritedMDC() throws Exception {
		System.setProperty(PaxContext.INHERIT_THREAD_CONTEXT_MAP_KEY, "true");
	...
	private void clear() throws Exception {
		System.getProperties().remove(PaxContext.INHERIT_THREAD_CONTEXT_MAP_KEY);
